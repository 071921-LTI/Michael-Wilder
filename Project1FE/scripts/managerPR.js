...
function approve() {
    ...
    status = "Approved";
            ...
            reimbursement1 = {
                reimbId: parseInt(reimbId.value),
                statId: statusType

            }
 
        let url = "http://localhost:8080/Project1/reimb/updateApprove";
        ...
        xhr.setRequestHeader("Authorize", token);
        xhr.send(JSON.stringify(reimbursement1));
 ...
 function deny() {
        ...
        let url = "http://localhost:8080/Project1/reimb/updateDeny";
